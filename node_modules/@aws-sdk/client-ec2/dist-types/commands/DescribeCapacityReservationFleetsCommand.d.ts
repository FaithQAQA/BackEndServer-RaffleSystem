...
import { DescribeCapacityReservationFleetsRequest, DescribeCapacityReservationFleetsResult } from "../models/models_4";
/**
 * @public
 */
...
declare const DescribeCapacityReservationFleetsCommand_base: {
    new (input: DescribeCapacityReservationFleetsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeCapacityReservationFleetsCommandInput, DescribeCapacityReservationFleetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeCapacityReservationFleetsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeCapacityReservationFleetsCommandInput, DescribeCapacityReservationFleetsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
